...
public class DashChunkSource implements ChunkSource, Output {
    ...
    * ChunkSource implementation.
     ...
     *  Override getChunkOperation() from ChunkSource Interface
     *   The instance of DashChunkSource (ex: videoChunkSource in DashRenderBuilder.java) is passed into ChunkSampleSource()
     *   This functions then is being called by  private void doChunkOperation() inside of ChunkSampleSource
     *   This doChunkOperation() is called by updateLoadControl(),resumeFromBackOff(),
     *   Functions:
    ...
    public final void getChunkOperation(List<? extends MediaChunk> queue, long playbackPositionUs,
        ...
        if (evaluation.format == null || !lastChunkWasInitialization) {
            if (enabledTrack.isAdaptive()) {
                Log.d(TAG, "getChunkOperateon(): Doing a Evaluation Now.");
    ...
    /**
     * Comments added by shuai
     * called by ChunkSampleSource.onLoadCompleted()
