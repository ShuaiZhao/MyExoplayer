...
public interface FormatEvaluator {
    ...
    public static final class AdaptiveEvaluator implements FormatEvaluator {
        ...
        public static final float DEFAULT_BANDWIDTH_FRACTION = 0.01f;
        ...
        public void evaluate(List<? extends MediaChunk> queue, long playbackPositionUs,
            ...
            Log.d("*FormatEvalutor: buffT", String.valueOf(bufferedDurationUs)+ " us, " + String.valueOf(bufferedDurationUs/1000000) + " s");

            //get the current Format information
            Format current = evaluation.format;

            //get the future/next estimate video format based the return the bandwidth testing
            long estimatedBW = bandwidthMeter.getBitrateEstimate();
            Log.d("*FormatEvalutor: EBW", String.valueOf(estimatedBW) + " bps, " + String.valueOf(estimatedBW/1000000) + " Mbps");
            Log.d("*FormatEvalutor: RBW", "The acutally bandwidth player is: -> " + String.valueOf(estimatedBW * bandwidthFraction/1000000) + " Mbps");
            ...
            Log.d("*FormatEvalutor: ",  "ID: [" + ideal.id + "] FrameRate: [" + frameRate + "] "  +
                    currentBPS+" bps, " +currentMBPS + " Mpbs");


            // test if the future/next video format's bitrate is bigger than the current one, set isHight == True
            ...
            if (isHigher) {
                if (bufferedDurationUs < minDurationForQualityIncreaseUs) {
                    ...
                    ideal = current;
                    Log.d("*FormatEvaluator: ", "not enough buffer left to improve video frame quality");
                    ...
                    Log.d("*FormatEvaluator: ", "video frame quality gets improved");
                ...
                // down for now.
                Log.d("*FormatEvaluator: ", "The ideal format is a lower quality, but we have sufficient buffer to defer switching down for now");
                ideal = current;
            }
