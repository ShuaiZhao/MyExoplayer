...
public class PlayerActivity extends Activity implements SurfaceHolder.Callback, OnClickListener,
    ...
    private DebugTextViewHelper debugViewHelper;  // a DebugTextViewHelper threader instance
...
//  private TextView graphPlotView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Log.d(TAG, "Write to a file: ");
            String current = new java.io.File( "." ).getCanonicalPath();
            System.out.println("Current dir:"+current);


            FileOutputStream fos = openFileOutput("Mylog.txt", Context.MODE_PRIVATE);
