...
/* package */ class Samples {
  ...
  public static final Sample[] WIDEVINE_HDCP = new Sample[] {
    ...
    * http://204.76.187.66/www-itec.uni-klu.ac.at/ftp/datasets/DASHDataset2014/BigBuckBunny/4sec/BigBuckBunny_4s_onDemand_2014_05_09.mpd
    * ***/
    public static final Sample[] MY_DASH_MPD = new Sample[] {
            new Sample("BigBuckBunny_4s",
                    "http://204.76.187.66/www-itec.uni-klu.ac.at/ftp/datasets/DASHDataset2014/BigBuckBunny/4sec/BigBuckBunny_4s_onDemand_2014_05_09.mpd",
                    Util.TYPE_DASH),
