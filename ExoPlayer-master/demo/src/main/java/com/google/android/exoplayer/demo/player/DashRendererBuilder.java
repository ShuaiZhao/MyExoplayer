...
public class DashRendererBuilder implements RendererBuilder {
    ...
    private static final int BUFFER_SEGMENT_SIZE = 64 * 1024;  //bytes
    ...
    /**
     * A DashRendererBuilder Constructor
     */
    ...
    /**
     * Return a AsyncRendererBuilder instance
     * AsyncRendererBuilder is a inner class of DashRendererBuilder
     * @param player The player for which renderers are being built. {@link DemoPlayer#onRenderers}
     *               should be invoked once the renderers have been built. If building fails,
     */
    @Override
    public void buildRenderers(DemoPlayer player) {
        Log.d("DASHRenderBuilder", "Build a DASH builder");
    ...
    private static final class AsyncRendererBuilder
        ...
        //AsyncRenderereBuilder Constructor
        public AsyncRendererBuilder(Context context, String userAgent, String url,
            ...
            //The DefaultUrlDataSource class
        ...
        /**
         * The actual DASH renderder builder function
         */
        private void buildRenderers() {
            Period period = manifest.getPeriod(0);
            Handler mainHandler = player.getMainHandler();

            //The default DASH load Control class: DefaultLoadControl
            LoadControl loadControl = new DefaultLoadControl(new DefaultAllocator(BUFFER_SEGMENT_SIZE));

            //The default BandWdith Testing class: DefaultLoadControl
